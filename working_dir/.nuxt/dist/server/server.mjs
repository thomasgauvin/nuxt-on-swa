...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/dynamic-17728246.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-b533dd77.js").then((m) => m.default || m)
  },
  {
    name: "static",
    path: "/static",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/static-95c641ac.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-84f3ce26.js").then((r) => r.default || r));
