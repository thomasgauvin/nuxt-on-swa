...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/hello", "$1hRnDUCfjg")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div> test dynamic </div> ${ssrInterpolate(unref(data).message)}<!--]-->`);
    };
  }
};
...
//# sourceMappingURL=dynamic-17728246.mjs.map
